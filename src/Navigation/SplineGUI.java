...
public class SplineGUI extends JPanel implements MouseMotionListener, MouseListener {
	...
	public SplineGUI(boolean addListeners) {
		intoOrbit.getWidth(this);
		intoOrbit.getHeight(this);
		wait(1000);
		System.out.println((double)intoOrbit.getWidth(this)*2/10 + ", " + (double)intoOrbit.getHeight(this)*2/10);
	...
	public void paint(Graphics g) {
		...
		g2d.drawString("1 px : 2 mm", 1055, 595);
