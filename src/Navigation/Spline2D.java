 ...
 * @author krueger
 */
public class Spline2D implements Spline{
     ...
     * @param points
     */
    public Spline2D(ArrayList<Point> points) {
    ...
    private void init(double[] x, double[] y) {
        ...
        splineX = new BSpline(t, x);
        splineY = new BSpline(t, y);
    }
    ...
    public BSpline getSplineX() {
        return splineX;
    }

    public BSpline getSplineY() {
        return splineY;
    }
